...
namespace GuiaTeoricayPractica2
{
    public partial class listView : Form
    {
        ...
        public listView()
        {
            ...
            DibujarListView(@"C:\");
            carpetacol.Add(@"C:\"); InitializeComponent();
        }
        ...
        private void DibujarListView(string root)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(root))
                    return;
                DirectoryInfo direct = new DirectoryInfo(root);
                ...
                foreach (FileInfo fi in archivos)
                {
                    lvi = new ListViewItem();
                    lvi.Text = fi.Name;
                    lvi.ImageIndex = 1;
        ...
        private void rbDitail_CheckedChanged(object sender, EventArgs e)
        {
            RadioButton rdb = (RadioButton)sender;
            if (rdb.Checked)
